...
import { SIN_VIDEO } from '../../lib/medidas';
import { useMediaQueryInicial } from '../../hooks/useMediaQuery';
...
export default function Hero({ loading, sinRiel, contactoAbierto, onContacto }) {
    ...
    // dé ya: es el mismo cuadro, con su alfa, en 39 KB. Debajo del corte de
    // `SIN_VIDEO`, que es donde el hero se apila, se sirve solo el póster.
    //
    // Va con la variante **inicial** del hook, que no escucha el cambio, y eso es
    // deliberado: ver la nota de `useMediaQueryInicial`.
    const angosto = useMediaQueryInicial(SIN_VIDEO);
